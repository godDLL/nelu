...
| `plan/INBOX/uint-wrap.md` | STILL OPEN | Rank 5. Small-uint arithmetic: nelu wraps (`200_u8 + 100_u8` -> `44`), the oracle promotes (`300`) or errors on assignment. Ticket text was inverted; corrected 2026-09-06. |
